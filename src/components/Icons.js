...
export const LeetCodeIcons = ({ className, ...rest }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={24}
    height={24}
...
export const InstagramIcons = ({ className, ...rest }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={24}
    height={24}
    ...
    {...rest}
  >
    <path d="M12 2.4c3.283 0 3.676.014 4.972.072 1.296.06 2.52.336 3.474 1.29.954.954 1.23 2.178 1.29 3.474.058 1.296.072 1.69.072 4.972s-.014 3.676-.072 4.972c-.06 1.296-.336 2.52-1.29 3.474-.954.954-2.178 1.23-3.474 1.29-1.296.058-1.69.072-4.972.072s-3.676-.014-4.972-.072c-1.296-.06-2.52-.336-3.474-1.29-.954-.954-1.23-2.178-1.29-3.474-.058-1.296-.072-1.69-.072-4.972s.014-3.676.072-4.972c.06-1.296.336-2.52 1.29-3.474.954-.954 2.178-1.23 3.474-1.29 1.296-.058 1.69-.072 4.972-.072zm0-1.2c-3.384 0-3.78.014-5.124.072-1.464.066-2.82.366-3.87 1.416S1.2 6.132 1.134 7.596c-.058 1.344-.072 1.74-.072 5.124s.014 3.78.072 5.124c.066 1.464.366 2.82 1.416 3.87s2.406 1.35 3.87 1.416c1.344.058 1.74.072 5.124.072s3.78-.014 5.124-.072c1.464-.066 2.82-.366 3.87-1.416s1.35-2.406 1.416-3.87c.058-1.344.072-1.74.072-5.124s-.014-3.78-.072-5.124c-.066-1.464-.366-2.82-1.416-3.87s-2.406-1.35-3.87-1.416c-1.344-.058-1.74-.072-5.124-.072z"/>
    <path d="M12 5.4a6.6 6.6 0 1 0 0 13.2 6.6 6.6 0 0 0 0-13.2zm0 11.4a4.8 4.8 0 1 1 0-9.6 4.8 4.8 0 0 1 0 9.6zm6-10.8c-.36 0-.6.24-.6.6s.24.6.6.6.6-.24.6-.6-.24-.6-.6-.6z"/>
  </svg>
);
...
export const YouTubeIcon = ({ className, ...rest }) => (
  <svg
    ...
    {...rest}
  >
    <path d="M21.498 7.75a2.727 2.727 0 0 0-1.928-1.928c-1.714-.4-6.825-.4-6.825-.4s-5.11 0-6.825.4a2.727 2.727 0 0 0-1.928 1.928C4 9.465 4 12 4 12s0 2.535.745 4.25a2.727 2.727 0 0 0 1.928 1.928c1.714.4 6.825.4 6.825.4s5.11 0 6.825-.4a2.727 2.727 0 0 0 1.928-1.928C22 14.535 22 12 22 12s0-2.535-.502-4.25zM10 15.75V8.25l6 3-6 3z"/>
  </svg>
);
